...
Use this folder as the operator-side companion structure for a Helm's Watch `v0.4.0` session, especially when you want a file-based notebook next to the in-app timeline, findings, and exports.
